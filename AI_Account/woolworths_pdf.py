...
def nutrition_content_extraction(file_path, pgs):
    ...
    return nutri_list
#-------------------------------------------------------------------------------------------------------------
#Serving content Extraction function
...
#------------------------------------------------------------------------------------------------
#Nutrition data values split function
...
#-------------------------------------------------------------------------------------------------------------
#Nutrition key_value classification
...
def serving_content(serving):
    ...
    #Serving key_value classification 
    serving_dic={}
...
def nutrition_main(file_path, pgs):
    ...
    return final
#------------------------------------------------------------------------------------------------------------
#Woolworths_PDF Main function

def woolworths_main(file_path, pages):
